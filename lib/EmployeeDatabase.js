        ...
        inquirer 
            ...
            .then((response) => {
                ...
                if (response.manager === 'None') {
                    console.log(response.manager);
                    db.query(`INSERT INTO employee (first_name, last_name, role_id) VALUES ('${response.firstName}', '${response.lastName}', ${response.role})`);
                    this.start();
                } else {
    ...
    updateRole() {
        ...
        inquirer
            ...
            .then((response) => {
                ...
                db.query(`UPDATE employee set role_id = ${response.role} WHERE CONCAT(employee.first_name, " ", employee.last_name) = "${response.employee}"`);
                this.start();
            })
    }
}
